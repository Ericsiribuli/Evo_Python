...
os.system("ccs --reportFile=ccs_report.txt --minLength=900 --maxLength=1600 --minPasses=5 --num-threads 30 --minPredictedAccuracy=0.95 --logFile=mylog.txt /mnt/data3/disk/smrtanalysis/bin/pacbio_new_yang/20200116_test_54061old/54061old_f.bam ./54061old_f_ccs.bam")
os.system("ccs --reportFile=ccs_report.txt --minLength=900 --maxLength=1600 --minPasses=5 --num-threads 30 --minPredictedAccuracy=0.95 --logFile=mylog.txt /mnt/data3/disk/smrtanalysis/bin/pacbio_new_yang/20200116_test_54061old/54061old_r.bam ./54061old_r_ccs.bam")

...
def blasr_subreads_to_ccs(zmw_single,read_list):#定义把每一个zmw的subredas通过blasr转换成ccs
    ...
    os.system("blasr --bam --out %s.blasr.new.bam %s.new.bam ref_T.fasta"%(zmw_single,zmw_single))
...
os.system("sed '/^\s*$/d' 54139_f.txt >54139_f.sam")
os.system("sed '/^\s*$/d' 54139_r.txt > 54139_r.sam")
os.system("samtools view -b -S 54139_f.sam > 54139_f.bam")
os.system("samtools view -b -S 54139_r.sam > 54139_r.bam")
os.system("ccs --reportFile=ccs_report.txt --minLength=900 --maxLength=1600 --minPasses=5 --numThreads 30 --minPredictedAccuracy=0.95 --logFile=mylog.txt /mnt/data3/disk/smrtanalysis/bin/pacbio_TGB/54139_f.bam ./54139_f_ccs.bam")
os.system("ccs --reportFile=ccs_report.txt --minLength=900 --maxLength=1600 --minPasses=5 --numThreads 30 --minPredictedAccuracy=0.95 --logFile=mylog.txt /mnt/data3/disk/smrtanalysis/bin/pacbio_TGB/54139_r.bam ./54139_r_ccs.bam")
os.system("samtools view -h -o 54139_f_ccs.sam 54139_f_ccs.bam")
os.system("samtools view -h -o 54139_r_ccs.sam 54139_r_ccs.bam")

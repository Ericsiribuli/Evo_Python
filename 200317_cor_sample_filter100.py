...
for i1 in file1:
    umi1 = i1.strip()[:20]
    sum1 +=1
    sample1_dict_pre[umi1] = sample1_dict_pre.get(umi1,0) + 1

for sss in sample1_dict_pre:
    if sample1_dict_pre[sss] > 100:
        sample1_dict[sss] = sample1_dict_pre[sss]

for i2 in file2:
    umi2 = i2.strip()[:20]
    sum2 +=1
    sample2_dict_pre[umi2] = sample2_dict_pre.get(umi2,0) + 1

for sss2 in sample2_dict_pre:
    if sample2_dict_pre[sss2]:
        sample2_dict[sss2] = sample2_dict_pre[sss2]
...
plt.savefig("%s_%s_100filter.png"%(sample1_name,sample2_name))

...
input_file_total,output_f,output_r=argv[1:]
# cpu_number=int(cpu)
header=""
fileoutput_f = open(output_f,"w")
fileoutput_r = open(output_r,"w")

with open(input_file_total,"r") as input_subreads:
    # count_reads=0
...
with open(input_file_total,"r") as input_bam:#分为正负
    f_list = []
    r_list = []

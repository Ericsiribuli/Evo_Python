...
os.system("sed '/^\s*$/d' 173101_f.txt > 173101_f.sam")
os.system("sed '/^\s*$/d' 173101_r.txt > 173101_r.sam")
os.system("samtools view -b -S 173101_f.sam > 173101_f.bam")
os.system("samtools view -b -S 173101_r.sam > 173101_r.bam")
os.system("ccs --reportFile=ccs_report.txt --minLength=900 --maxLength=1600 --minPasses=5 --numThreads 30 --minPredictedAccuracy=0.95 --logFile=mylog.txt /mnt/data/home/smrtanalysis/opt/pacbio/smrtlink/install/smrtlink-release_5.1.0.26412/bundles/smrttools/install/smrttools-release_5.1.0.26366/smrtcmds/bin/pacbio_new_yang/Y_3-9_173101_XZ/173101_f.bam ./173101_f_ccs.bam")
os.system("ccs --reportFile=ccs_report.txt --minLength=900 --maxLength=1600 --minPasses=5 --numThreads 30 --minPredictedAccuracy=0.95 --logFile=mylog.txt /mnt/data/home/smrtanalysis/opt/pacbio/smrtlink/install/smrtlink-release_5.1.0.26412/bundles/smrttools/install/smrttools-release_5.1.0.26366/smrtcmds/bin/pacbio_new_yang/Y_3-9_173101_XZ/173101_r.bam ./173101_r_ccs.bam")
os.system("samtools view -h -o 173101_f_ccs.sam 173101_f_ccs.bam")
os.system("samtools view -h -o 173101_r_ccs.sam 173101_r_ccs.bam")
